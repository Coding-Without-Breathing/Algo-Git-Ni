...
<p align="center">소프트웨어 마에스트로 12기 과정의 미니 프로젝트로써 기획 및 개발된 **알고있니 봇**은 카카오 워크 앱에서 작동되는 **Node.js 기반의 챗봇**입니다. 봇 이름인 '알고있니' 는 `Algorithm 의 '알고' + Git 의 '있' (C적 허용) + '니'` 로 이루어져있어, 봇이 제공하는 두 가지 큰 기능을 상징적으로 나타냅니다.</p>
&nbsp &nbsp 
